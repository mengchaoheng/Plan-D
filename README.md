...
For priority control allocation, it is recommended to use our [PINDI](https://github.com/mengchaoheng/PINDI). For ducted drone simulation, it is recommended to use our [DFUAV project](https://github.com/mengchaoheng/DuctedFanUAV-Autopilot).
